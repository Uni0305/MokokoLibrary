package me.uni0305.mokoko.library.nms.v1_21_r3;
...
public class JsonItemStackSerializer implements JsonSerializer<ItemStack> {
    ...
    public @NotNull JsonElement serialize(@NotNull ItemStack obj) {
        ...
        CompoundTag nbt = (CompoundTag) nms.save(RegistryAccess.EMPTY);
    ...
    public @Nullable ItemStack deserialize(@NotNull JsonElement src) {
        ...
        net.minecraft.world.item.ItemStack nms = net.minecraft.world.item.ItemStack.parseOptional(RegistryAccess.EMPTY, nbt);
